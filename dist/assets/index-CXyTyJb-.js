...
async def fetch_data_async():
    ...
    return "Data Fetched"`},{csharp:`List<T>`,python:`list`,category:`collections`,desc:`Dynamically sized arrays. C# is strongly-typed, whereas Python lists can hold heterogeneous elements.`,csharpCode:`// C# Strongly Typed List
var list = new List<string> { "a", "b" };
list.Add("c");
string first = list[0];`,pythonCode:`# Python Dynamic List
list_items = ["a", "b"]
list_items.append("c")
first = list_items[0]`},{csharp:`Dictionary<TKey, TValue>`,python:`dict`,category:`collections`,desc:`Key-value pair collections. Written in Python with curly braces. Dictionaries preserve insertion order in modern Python.`,csharpCode:`// C# Dictionary
var dict = new Dictionary<string, int> {
    { "key", 1 }
};
dict["key"] = 2;`,pythonCode:`# Python Dictionary
my_dict = {
    "key": 1
}
my_dict["key"] = 2`},{csharp:`interface`,python:`ABC / typing.Protocol`,category:`oop`,desc:`C# uses explicit interfaces. Python uses Duck Typing naturally, but can enforce contract validation using Abstract Base Classes (ABC) or Protocol.`,csharpCode:`// C# Interface & Implementation
...
class Service(Protocol):
    def execute(self) -> None:
        ...`},{csharp:`namespace`,python:`module / package`,category:`oop`,desc:`C# organizes code with namespace scopes. Python uses files (modules) and folders with __init__.py (packages) to construct paths.`,csharpCode:`// C# Namespace
namespace MyApp.Services {
    public class Processor {}
}`,pythonCode:`# Python Module (my_app/services.py)
# Usage: from my_app.services import Processor
class Processor:
    pass`},{csharp:`Console.WriteLine()`,python:`print()`,category:`basics`,desc:`Prints output to console. Python print() automatically appends a newline unless configured otherwise.`,csharpCode:`// C# Console Output
Console.WriteLine($"Value: {val}");`,pythonCode:`# Python Print Output
print(f"Value: {val}")`},{csharp:`class / constructor`,python:`class / __init__(self)`,category:`oop`,desc:`C# uses class name as constructor. Python uses the special method __init__ with explicit 'self' as the first parameter.`,csharpCode:`// C# Class
public class User {
...
class User:
    def __init__(self, name: str):
        self.name = name`},{csharp:`null`,python:`None`,category:`basics`,desc:`Represents the absence of value. Python uses the singleton object None instead of null.`,csharpCode:`// C# Null Check
User user = null;
if (user == null) {
    // handle null
...
if user is None:
    # handle None
    pass`},{csharp:`var`,python:`(implicitly typed)`,category:`basics`,desc:`C# uses var for local type inference. Python is dynamically typed by default, meaning variables can change types at runtime.`,csharpCode:`// C# var
var age = 25;
var name = "Baqar";`,pythonCode:`# Python Implicit
age = 25
name = "Baqar"`},{csharp:`linq (Select/Where)`,python:`List Comprehensions / filter() / map()`,category:`advanced`,desc:`LINQ expressions in C# translate directly to list comprehensions or standard functions in Python.`,csharpCode:`// C# LINQ Query
var evens = list
    .Where(x => x % 2 == 0)
    .Select(x => x * 2);`,pythonCode:`# Python List Comprehension
evens = [x * 2 for x in my_list if x % 2 == 0]`},{csharp:`string.Format() / $""`,python:`f-strings (f"{var}")`,category:`basics`,desc:`String interpolation. C# uses dollar-sign strings. Python uses f-prefix strings which are highly optimized.`,csharpCode:`// C# Interpolation
var msg = $"Hello {name}, age {age}";`,pythonCode:`# Python f-string
msg = f"Hello {name}, age {age}"`},{csharp:`try / catch / finally`,python:`try / except / finally`,category:`basics`,desc:`Error handling blocks. C# uses 'catch (Exception e)', Python uses 'except Exception as e'.`,csharpCode:`// C# Exception Handling
try {
    DoWork();
} catch (Exception ex) {
    Log(ex.Message);
...
try:
    ...
    cleanup()`}],st=(e,t)=>{let n=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`),r=[],i=t===`csharp`?/(\/\/.*)/g:/(\#.*)/g;n=n.replace(/("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,e=>{let t=`___STR_TOKEN_${r.length}___`;return r.push(`<span class="token string">${e}</span>`),t}),n=n.replace(i,e=>{let t=`___COM_TOKEN_${r.length}___`;return r.push(`<span class="token comment">${e}</span>`),t}),n=t===`csharp`?n.replace(/\b(public|private|protected|async|await|var|new|class|interface|string|int|void|return|try|catch|finally|null|using|namespace|get|set)\b/g,`<span class="token keyword">$1</span>`).replace(/\b(Console|WriteLine|List|Dictionary|Task|Exception|DoWork|Cleanup|Log|FetchDataAsync|Delay)\b/g,`<span class="token type">$1</span>`):n.replace(/\b(def|async|await|import|class|None|pass|try|except|finally|from|in|if|as|and|or|not|elif|else|import)\b/g,`<span class="token keyword">$1</span>`).replace(/\b(print|asyncio|sleep|append|len|range|self|do_work|cleanup|log|str|fetch_data_async)\b/g,`<span class="token type">$1</span>`),n=n.replace(/\b(\d+)\b/g,`<span class="token number">$1</span>`);for(let e=r.length-1;e>=0;e--)n=n.split(`___STR_TOKEN_${e}___`).join(r[e]),n=n.split(`___COM_TOKEN_${e}___`).join(r[e]);return n},ct=()=>{let[e]=(0,_.useState)(at),[t,n]=(0,_.useState)({}),[r,i]=(0,_.useState)({}),[a,o]=(0,_.useState)(1),[s,c]=(0,_.useState)(1),[l,u]=(0,_.useState)(()=>{let e=localStorage.getItem(`roadmapTheme`);return e===`light`||e===`dark`?e:`light`});(0,_.useEffect)(()=>{localStorage.setItem(`roadmapTheme`,l)},[l]);let[d,f]=(0,_.useState)(()=>{let e=sessionStorage.getItem(`roadmapRole`);return e===`admin`||e===`visitor`?e:sessionStorage.getItem(`adminToken`)?`admin`:null}),[p,m]=(0,_.useState)(()=>sessionStorage.getItem(`roadmapToken`)||sessionStorage.getItem(`adminToken`)),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)(``),[x,ee]=(0,_.useState)(``),[S,C]=(0,_.useState)(null),[te,ne]=(0,_.useState)(!1),[re,w]=(0,_.useState)(null),[T,ie]=(0,_.useState)(``),[E,ae]=(0,_.useState)(``),[ce,D]=(0,_.useState)(``),[le,de]=(0,_.useState)(!1),[fe,k]=(0,_.useState)(!1),[_e,ve]=(0,_.useState)(``),[ye,be]=(0,_.useState)(!1),[xe,Se]=(0,_.useState)(`all`),[Te,Ee]=(0,_.useState)(``),Oe=e=>{let t=e.toLowerCase();return t===`learn`?(0,b.jsx)(se,{size:11,strokeWidth:2.5,style:{marginRight:`4px`}}):t===`code`?(0,b.jsx)(he,{size:11,strokeWidth:2.5,style:{marginRight:`4px`}}):t===`build`?(0,b.jsx)(Be,{size:11,strokeWidth:2.5,style:{marginRight:`4px`}}):t===`review`?(0,b.jsx)(Ne,{size:11,strokeWidth:2.5,style:{marginRight:`4px`}}):null};(0,_.useEffect)(()=>{let e=sessionStorage.getItem(`adminToken`),t=sessionStorage.getItem(`roadmapLoggedOut`);e&&d!==`admin`&&t!==`true`&&(f(`admin`),m(e),sessionStorage.setItem(`roadmapRole`,`admin`),sessionStorage.setItem(`roadmapToken`,e))},[d]),(0,_.useEffect)(()=>{p&&d?ke():(n({}),i({}))},[p,d]),(0,_.useEffect)(()=>{let e=r[`week_${s}`];e?(ie(e.learned||``),ae(e.difficulties||``),D(e.notes||``)):(ie(``),ae(``),D(``)),Ee(``)},[s,r]);let ke=async e=>{let t=e||p;if(t)try{let e={Authorization:`Bearer ${t}`},[r,a]=await Promise.all([fetch(`/api/roadmap/progress`,{headers:e}),fetch(`/api/roadmap/journal`,{headers:e})]);if(r.status===401||a.status===401){Me();return}if(r.ok&&a.ok){let e=await r.json(),t=await a.json(),o={};e.forEach(e=>{o[e.taskId]=e.completed}),n(o);let s={};return t.forEach(e=>{s[e.weekId]=e}),i(s),{progressMap:o,journalMap:s}}}catch(e){console.error(`Failed to load roadmap data:`,e)}},Ae=async e=>{e.preventDefault(),ne(!0),C(null);try{let e=await fetch(`/api/roadmap/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:v,password:x})}),t=await e.json();if(!e.ok)throw Error(t.error||`Authentication failed`);sessionStorage.setItem(`roadmapToken`,t.token),sessionStorage.setItem(`roadmapRole`,t.role),sessionStorage.removeItem(`roadmapLoggedOut`),t.role===`admin`&&sessionStorage.setItem(`adminToken`,t.token),m(t.token),f(t.role),g(!1),y(``),ee(``);let r=await ke(t.token);if(re){if(re.startsWith(`toggle_`)){let e=re.replace(`toggle_`,``),i=!(r&&r.progressMap[e]);n(t=>({...t,[e]:i}));try{await fetch(`/api/roadmap/progress`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${t.token}`},body:JSON.stringify({taskId:e,completed:i})})}catch(e){console.error(`Failed to save pending toggle:`,e)}}else if(re===`save_journal`){let e=`week_${s}`;de(!0);try{await fetch(`/api/roadmap/journal`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${t.token}`},body:JSON.stringify({id:e,learned:T,difficulties:E,notes:ce})}),i(t=>({...t,[e]:{weekId:e,learned:T,difficulties:E,notes:ce}})),k(!0),setTimeout(()=>k(!1),3e3)}catch(e){console.error(`Failed to save pending journal:`,e)}finally{de(!1)}}}w(null)}catch(e){C(e.message||`Connection error. Please try again.`)}finally{ne(!1)}},Me=()=>{sessionStorage.removeItem(`roadmapToken`),sessionStorage.removeItem(`roadmapRole`),sessionStorage.setItem(`roadmapLoggedOut`,`true`),m(null),f(null),n({}),i({})},Pe=async e=>{if(!d||!p){w(`toggle_${e}`),g(!0);return}let r=!!t[e],i=!r;n(t=>({...t,[e]:i}));try{if(!(await fetch(`/api/roadmap/progress`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${p}`},body:JSON.stringify({taskId:e,completed:i})})).ok)throw Error()}catch(t){console.error(`Failed to update task completion:`,t),n(t=>({...t,[e]:r}))}},Ie=async()=>{if(!d||!p){w(`save_journal`),g(!0);return}let e=`week_${s}`;de(!0);try{if(!(await fetch(`/api/roadmap/journal`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${p}`},body:JSON.stringify({id:e,learned:T,difficulties:E,notes:ce})})).ok)throw Error();i(t=>({...t,[e]:{weekId:e,learned:T,difficulties:E,notes:ce}})),k(!0),setTimeout(()=>k(!1),3e3)}catch(e){console.error(`Failed to save journal notes:`,e),alert(`Error saving notes. Please try again.`)}finally{de(!1)}},Le=t=>{o(t);let n=e.find(e=>e.id===t);n&&n.weeks.length>0&&c(n.weeks[0].id)},ze=0,He=0,Ue=0,We=Object.keys(r).length;e.forEach(e=>{e.weeks.forEach(e=>{let n=e.focus_hours.match(/(\d+)\s*hours?/i);n&&(Ue+=parseInt(n[1],10)),e.days.forEach(e=>{e.tasks.forEach(e=>{ze++,t[e.id]&&He++})})})});let Ge=ze>0?Math.round(He/ze*100):0,Ke=e.filter(e=>e.weeks.length>0),qe=e.find(e=>e.id===a),Je=qe?.weeks.find(e=>e.id===s),Ye=Je?Te.trim()===``?Je.days:Je.days.map(e=>{let t=e.tasks.filter(e=>e.content.toLowerCase().includes(Te.trim().toLowerCase()));return{...e,tasks:t}}).filter(e=>e.tasks.length>0):[];return(0,b.jsxs)(`div`,{className:`roadmap-wrapper theme-${l}`,children:[(0,b.jsxs)(`div`,{className:`roadmap-app-container container`,children:[(0,b.jsxs)(`header`,{className:`roadmap-header`,children:[(0,b.jsxs)(`div`,{className:`roadmap-version-badge font-mono`,children:[(0,b.jsx)(`span`,{className:`roadmap-badge-dot`}),(0,b.jsx)(`span`,{children:`GENAI ROADMAP // INTERACTIVE TRACKER`})]}),(0,b.jsxs)(`div`,{className:`roadmap-header-title-row`,children:[(0,b.jsx)(`h1`,{className:`roadmap-title`,children:`GenAI Roadmap Activity Tracker`}),(0,b.jsxs)(`div`,{className:`roadmap-header-actions font-mono`,children:[(0,b.jsx)(`button`,{onClick:()=>u(l===`light`?`dark`:`light`),className:`roadmap-theme-toggle-btn`,title:`Switch to ${l===`light`?`dark`:`light`} mode`,children:l===`light`?(0,b.jsx)(De,{size:15}):(0,b.jsx)(Fe,{size:15})}),d?(0,b.jsxs)(`button`,{onClick:Me,className:`roadmap-logout-btn font-mono`,children:[(0,b.jsx)(we,{size:14}),(0,b.jsxs)(`span`,{children:[`Log out (`,d,`)`]})]}):(0,b.jsxs)(`button`,{onClick:()=>{w(null),g(!0)},className:`roadmap-login-btn font-mono`,children:[(0,b.jsx)(Ce,{size:14}),(0,b.jsx)(`span`,{children:`Track Progress`})]})]})]}),(0,b.jsx)(`p`,{className:`roadmap-subtitle`,children:`Track your learning checkpoints, tasks progress, and retrospective journal notes across the 24-week curriculum.`})]}),!d&&(0,b.jsxs)(`div`,{className:`roadmap-banner-alert font-mono`,children:[(0,b.jsx)(A,{size:16}),(0,b.jsxs)(`span`,{children:[`Viewing in read-only guest mode. To mark tasks and save journal logs, click `,(0,b.jsx)(`strong`,{children:`Track Progress`}),` and log in with visitor account (`,(0,b.jsx)(`code`,{children:`visitor`}),` / `,(0,b.jsx)(`code`,{children:`visitor110`}),`).`]})]}),(0,b.jsxs)(`section`,{className:`roadmap-stats-grid`,children:[(0,b.jsxs)(`div`,{className:`roadmap-stat-card`,children:[(0,b.jsx)(`div`,{className:`roadmap-stat-icon`,children:(0,b.jsx)(Re,{size:24})}),(0,b.jsxs)(`div`,{className:`roadmap-stat-info`,children:[(0,b.jsxs)(`span`,{className:`roadmap-stat-val`,children:[Ge,`%`]}),(0,b.jsx)(`span`,{className:`roadmap-stat-lbl`,children:`OVERALL PROGRESS`})]})]}),(0,b.jsxs)(`div`,{className:`roadmap-stat-card`,children:[(0,b.jsx)(`div`,{className:`roadmap-stat-icon`,children:(0,b.jsx)(pe,{size:24})}),(0,b.jsxs)(`div`,{className:`roadmap-stat-info`,children:[(0,b.jsxs)(`span`,{className:`roadmap-stat-val`,children:[He,` `,(0,b.jsxs)(`span`,{className:`roadmap-stat-total`,children:[`/ `,ze]})]}),(0,b.jsx)(`span`,{className:`roadmap-stat-lbl`,children:`TASKS COMPLETED`})]})]}),(0,b.jsxs)(`div`,{className:`roadmap-stat-card`,children:[(0,b.jsx)(`div`,{className:`roadmap-stat-icon`,children:(0,b.jsx)(me,{size:24})}),(0,b.jsxs)(`div`,{className:`roadmap-stat-info`,children:[(0,b.jsxs)(`span`,{className:`roadmap-stat-val`,children:[`~`,Ue,` hrs`]}),(0,b.jsx)(`span`,{className:`roadmap-stat-lbl`,children:`CURRICULUM SIZE`})]})]}),(0,b.jsxs)(`div`,{className:`roadmap-stat-card`,children:[(0,b.jsx)(`div`,{className:`roadmap-stat-icon`,children:(0,b.jsx)(oe,{size:24})}),(0,b.jsxs)(`div`,{className:`roadmap-stat-info`,children:[(0,b.jsxs)(`span`,{className:`roadmap-stat-val`,children:[We,` `,(0,b.jsx)(`span`,{className:`roadmap-stat-total`,children:`/ 24`})]}),(0,b.jsx)(`span`,{className:`roadmap-stat-lbl`,children:`WEEKLY JOURNALS FILLED`})]})]})]}),(0,b.jsxs)(`div`,{className:`roadmap-dashboard-layout`,children:[(0,b.jsxs)(`aside`,{className:`roadmap-sidebar`,children:[(0,b.jsxs)(`div`,{className:`roadmap-navigation-panel`,children:[(0,b.jsx)(`div`,{className:`roadmap-nav-section-title`,children:`ROADMAP MONTHS`}),(0,b.jsx)(`ul`,{className:`roadmap-month-list`,children:Ke.map(e=>{let n=0,r=0;e.weeks.forEach(e=>{e.days.forEach(e=>{e.tasks.forEach(e=>{n++,t[e.id]&&r++})})});let i=n>0?Math.round(r/n*100):0;return(0,b.jsx)(`li`,{children:(0,b.jsxs)(`button`,{className:`roadmap-month-nav-btn ${a===e.id?`active`:``}`,onClick:()=>Le(e.id),children:[(0,b.jsxs)(`span`,{className:`roadmap-month-nav-title`,children:[`M`,e.id,`: `,e.title]}),(0,b.jsxs)(`span`,{className:`roadmap-month-nav-progress font-mono`,children:[i,`%`]})]})},e.id)})})]}),Je&&Je.csharp_mindset&&(0,b.jsxs)(`div`,{className:`roadmap-companion-card`,children:[(0,b.jsxs)(`span`,{className:`roadmap-companion-title font-mono`,children:[(0,b.jsx)(ge,{size:16}),`Mindset Shift`]}),(0,b.jsx)(`div`,{className:`roadmap-companion-body`,dangerouslySetInnerHTML:{__html:Je.csharp_mindset}})]}),(0,b.jsxs)(`div`,{className:`roadmap-companion-card roadmap-sidebar-glossary`,style:{cursor:`pointer`,transition:`var(--transition-smooth)`},onClick:()=>be(!0),children:[(0,b.jsxs)(`span`,{className:`roadmap-companion-title font-mono`,children:[(0,b.jsx)(se,{size:16}),`Parallel Syntax`]}),(0,b.jsxs)(`div`,{className:`roadmap-companion-body font-sans`,style:{borderLeft:`3px solid var(--accent)`,paddingLeft:`10px`},children:[(0,b.jsx)(`p`,{style:{margin:0,fontSize:`13px`,color:`var(--text-secondary)`},children:`A quick comparative lookup of C# constructs mapping directly to Python equivalents.`}),(0,b.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,marginTop:`12px`},children:[(0,b.jsx)(`span`,{className:`font-mono`,style:{fontSize:`11px`,color:`var(--text-muted)`,background:`var(--code-bg)`,padding:`2px 6px`,borderRadius:`4px`},children:`12 rules loaded`}),(0,b.jsx)(`span`,{className:`font-mono`,style:{fontSize:`12px`,color:`var(--accent)`,fontWeight:600,display:`inline-flex`,alignItems:`center`,gap:`4px`},children:`Open Guide →`})]})]})]})]}),(0,b.jsxs)(`main`,{className:`roadmap-content-area`,children:[qe&&(0,b.jsx)(`div`,{className:`roadmap-week-tabs`,children:qe.weeks.map(e=>(0,b.jsxs)(`button`,{className:`roadmap-week-tab-btn ${s===e.id?`active`:``}`,onClick:()=>c(e.id),children:[`Week `,e.week_number]},e.id))}),Je&&(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)(`div`,{className:`roadmap-week-info-card`,children:[(0,b.jsxs)(`div`,{className:`roadmap-week-info-header`,children:[(0,b.jsxs)(`h2`,{className:`roadmap-week-info-title`,children:[`Week `,Je.week_number,` — `,Je.title]}),(0,b.jsx)(`span`,{className:`roadmap-week-info-meta`,children:Je.focus_hours})]}),Je.weekly_goal&&(0,b.jsxs)(`div`,{className:`roadmap-goal-box`,children:[(0,b.jsx)(O,{size:16}),(0,b.jsxs)(`p`,{className:`roadmap-goal-text`,children:[(0,b.jsx)(`strong`,{children:`Goal:`}),` `,Je.weekly_goal]})]})]}),(0,b.jsxs)(`div`,{className:`roadmap-week-search-row`,children:[(0,b.jsxs)(`div`,{className:`roadmap-week-search-container`,children:[(0,b.jsx)(je,{size:14,className:`roadmap-week-search-icon`}),(0,b.jsx)(`input`,{type:`text`,className:`roadmap-week-search-input`,placeholder:`Search tasks in Week ${Je.week_number}... (e.g., Corey Schafer)`,value:Te,onChange:e=>Ee(e.target.value)}),Te&&(0,b.jsx)(`button`,{className:`roadmap-week-search-clear-btn`,onClick:()=>Ee(``),children:(0,b.jsx)(Ve,{size:14})})]}),Te&&(0,b.jsxs)(`span`,{className:`roadmap-week-search-status font-mono`,children:[Ye.reduce((e,t)=>e+t.tasks.length,0),` match(es) found`]})]}),Ye.length>0?(0,b.jsx)(`div`,{className:`roadmap-day-grid`,children:Ye.map(e=>(0,b.jsxs)(`div`,{className:`roadmap-day-card`,children:[(0,b.jsxs)(`div`,{className:`roadmap-day-header`,children:[(0,b.jsxs)(`div`,{className:`roadmap-day-title-group`,children:[(0,b.jsx)(`span`,{className:`roadmap-day-name`,children:e.day_name}),(0,b.jsx)(`span`,{className:`roadmap-day-hrs`,children:e.hours})]}),(0,b.jsxs)(`span`,{className:`roadmap-day-type type-${e.type.toLowerCase()}`,children:[Oe(e.type),e.type]})]}),(0,b.jsx)(`ul`,{className:`roadmap-task-list`,children:e.tasks.map(e=>{let n=!!t[e.id];return(0,b.jsxs)(`li`,{className:`roadmap-task-item ${n?`completed`:``}`,onClick:t=>{t.target.closest(`a`)||Pe(e.id)},children:[(0,b.jsx)(`div`,{className:`roadmap-task-checkbox-container ${n?`checked`:``}`,children:n&&(0,b.jsx)(ue,{size:10,strokeWidth:4})}),(0,b.jsxs)(`span`,{className:`roadmap-task-text`,children:[(0,b.jsx)(`span`,{className:`roadmap-task-num-badge`,children:e.task_num}),(0,b.jsx)(`span`,{dangerouslySetInnerHTML:{__html:e.content}})]})]},e.id)})})]},e.id))}):(0,b.jsxs)(`div`,{className:`roadmap-syntax-empty font-sans`,style:{background:`var(--bg-card)`,border:`1px solid var(--border-color)`,borderRadius:`var(--radius-md)`,padding:`3rem`,textAlign:`center`},children:[`No tasks matching "`,Te,`" found in Week `,Je.week_number,`.`]}),(0,b.jsxs)(`section`,{className:`roadmap-journal-section`,children:[(0,b.jsxs)(`h2`,{className:`roadmap-week-info-title`,children:[`Week `,Je.week_number,` — Retro Log`]}),(0,b.jsx)(`span`,{className:`roadmap-week-info-meta`,children:fe?(0,b.jsxs)(`span`,{className:`roadmap-journal-saved-lbl font-mono`,style:{color:`var(--color-build)`,display:`inline-flex`,alignItems:`center`,gap:`4px`},children:[(0,b.jsx)(ue,{size:14}),`Log Saved`]}):`RETROSPECTIVE LOG // WEEK ${Je.week_number}`}),(0,b.jsxs)(`div`,{className:`roadmap-journal-grid font-sans`,children:[(0,b.jsxs)(`div`,{className:`roadmap-journal-field`,children:[(0,b.jsx)(`label`,{className:`roadmap-journal-label`,children:`💡 What I learned this week`}),(0,b.jsx)(`textarea`,{className:`roadmap-journal-input`,placeholder:d?`Summarize key concepts, tools, or experiments...`:`Login to write/save notes...`,disabled:!d,value:T,onChange:e=>ie(e.target.value)})]}),(0,b.jsxs)(`div`,{className:`roadmap-journal-field`,children:[(0,b.jsx)(`label`,{className:`roadmap-journal-label`,children:`⚠️ Difficulties & Bugs`}),(0,b.jsx)(`textarea`,{className:`roadmap-journal-input`,placeholder:d?`Mention errors, roadblocks or things to study further...`:`Login to write/save notes...`,disabled:!d,value:E,onChange:e=>ae(e.target.value)})]}),(0,b.jsxs)(`div`,{className:`roadmap-journal-field`,children:[(0,b.jsx)(`label`,{className:`roadmap-journal-label`,children:`📝 General Review & Ideas`}),(0,b.jsx)(`textarea`,{className:`roadmap-journal-input`,placeholder:d?`Reflections, next steps, coding project sketches...`:`Login to write/save notes...`,disabled:!d,value:ce,onChange:e=>D(e.target.value)})]})]}),(0,b.jsx)(`div`,{className:`roadmap-journal-footer`,children:(0,b.jsx)(`button`,{onClick:Ie,disabled:le,className:`roadmap-btn-primary`,children:le?`Saving...`:`Save Review`})})]})]})]})]})]}),h&&(0,b.jsx)(`div`,{className:`roadmap-modal-overlay`,onClick:e=>{e.target===e.currentTarget&&g(!1)},children:(0,b.jsxs)(`div`,{className:`roadmap-modal-card`,children:[(0,b.jsxs)(`div`,{className:`roadmap-modal-header`,children:[(0,b.jsxs)(`span`,{className:`roadmap-modal-title`,children:[(0,b.jsx)(Ce,{size:16}),`Access Gatekeeper`]}),(0,b.jsx)(`button`,{onClick:()=>g(!1),className:`roadmap-modal-close`,children:(0,b.jsx)(Ve,{size:18})})]}),(0,b.jsxs)(`form`,{onSubmit:Ae,className:`roadmap-modal-form`,children:[(0,b.jsx)(`p`,{className:`roadmap-modal-description`,children:re?`Authentication is required to modify roadmap progress or save review logs.`:`Sign in to track progress checklists and write retrospective review logs.`}),(0,b.jsx)(`div`,{className:`roadmap-modal-credentials-note`,children:(0,b.jsxs)(`span`,{children:[(0,b.jsx)(`strong`,{children:`Visitors`}),`: Login with `,(0,b.jsx)(`code`,{children:`visitor`}),` / `,(0,b.jsx)(`code`,{children:`visitor110`})]})}),S&&(0,b.jsxs)(`div`,{className:`roadmap-modal-error font-mono`,children:[(0,b.jsx)(A,{size:14}),(0,b.jsx)(`span`,{children:S})]}),(0,b.jsxs)(`div`,{className:`roadmap-modal-field`,children:[(0,b.jsx)(`label`,{className:`roadmap-modal-label`,children:`Username`}),(0,b.jsx)(`input`,{type:`text`,required:!0,className:`roadmap-modal-input`,placeholder:`Username`,value:v,onChange:e=>y(e.target.value)})]}),(0,b.jsxs)(`div`,{className:`roadmap-modal-field`,children:[(0,b.jsx)(`label`,{className:`roadmap-modal-label`,children:`Password`}),(0,b.jsx)(`input`,{type:`password`,required:!0,className:`roadmap-modal-input`,placeholder:`••••••••`,value:x,onChange:e=>ee(e.target.value)})]}),(0,b.jsx)(`button`,{type:`submit`,disabled:te,className:`roadmap-modal-btn`,children:te?`Verifying...`:`Authenticate`})]})]})}),ye&&(0,b.jsx)(`div`,{className:`roadmap-modal-overlay roadmap-syntax-modal-overlay`,onClick:e=>{e.target===e.currentTarget&&be(!1)},children:(0,b.jsxs)(`div`,{className:`roadmap-modal-card roadmap-syntax-modal-card`,children:[(0,b.jsxs)(`div`,{className:`roadmap-modal-header`,children:[(0,b.jsxs)(`span`,{className:`roadmap-modal-title`,children:[(0,b.jsx)(se,{size:16}),`Parallel Syntax Guide`]}),(0,b.jsx)(`button`,{onClick:()=>be(!1),className:`roadmap-modal-close`,children:(0,b.jsx)(Ve,{size:18})})]}),(0,b.jsxs)(`div`,{className:`roadmap-syntax-modal-body`,children:[(0,b.jsx)(`p`,{className:`roadmap-syntax-modal-description font-sans`,children:`A quick-reference lookup comparing C# constructs and their Python equivalents. Select a category or use the search bar to filter rules.`}),(0,b.jsxs)(`div`,{className:`roadmap-syntax-filter-row`,children:[(0,b.jsxs)(`div`,{className:`roadmap-syntax-search-container`,children:[(0,b.jsx)(je,{size:14,className:`roadmap-syntax-search-icon`}),(0,b.jsx)(`input`,{type:`text`,className:`roadmap-syntax-search-input`,placeholder:`Search syntax maps...`,value:_e,onChange:e=>ve(e.target.value)}),_e&&(0,b.jsx)(`button`,{onClick:()=>ve(``),style:{position:`absolute`,right:`10px`,background:`none`,border:`none`,color:`var(--text-muted)`,cursor:`pointer`},children:(0,b.jsx)(Ve,{size:14})})]}),(0,b.jsx)(`div`,{className:`roadmap-syntax-categories font-mono`,children:[`all`,`basics`,`collections`,`oop`,`advanced`].map(e=>(0,b.jsx)(`button`,{className:`roadmap-syntax-cat-btn ${xe===e?`active`:``}`,onClick:()=>Se(e),children:e.toUpperCase()},e))})]}),(0,b.jsxs)(`div`,{className:`roadmap-syntax-cards-grid`,children:[ot.filter(e=>{let t=xe===`all`||e.category===xe,n=e.csharp.toLowerCase().includes(_e.toLowerCase())||e.python.toLowerCase().includes(_e.toLowerCase())||e.desc.toLowerCase().includes(_e.toLowerCase());return t&&n}).map((e,t)=>(0,b.jsxs)(`div`,{className:`roadmap-syntax-card`,children:[(0,b.jsxs)(`div`,{className:`roadmap-syntax-card-header`,children:[(0,b.jsxs)(`div`,{className:`roadmap-syntax-card-title`,children:[(0,b.jsx)(`span`,{className:`roadmap-syntax-badge-cs font-mono`,children:`C#`}),(0,b.jsx)(`span`,{className:`roadmap-syntax-term-cs font-mono`,children:e.csharp})]}),(0,b.jsx)(`div`,{className:`roadmap-syntax-card-arrow font-mono`,children:`→`}),(0,b.jsxs)(`div`,{className:`roadmap-syntax-card-title`,children:[(0,b.jsx)(`span`,{className:`roadmap-syntax-badge-py font-mono`,children:`Python`}),(0,b.jsx)(`span`,{className:`roadmap-syntax-term-py font-mono`,children:e.python})]})]}),(0,b.jsx)(`div`,{className:`roadmap-syntax-card-desc font-sans`,children:e.desc}),(0,b.jsxs)(`div`,{className:`roadmap-syntax-card-code-section`,children:[(0,b.jsxs)(`div`,{style:{position:`relative`},children:[(0,b.jsx)(`span`,{className:`roadmap-syntax-code-label font-mono`,children:`C#`}),(0,b.jsx)(`pre`,{className:`code-block font-mono`,children:(0,b.jsx)(`code`,{dangerouslySetInnerHTML:{__html:st(e.csharpCode,`csharp`)}})})]}),(0,b.jsxs)(`div`,{style:{position:`relative`},children:[(0,b.jsx)(`span`,{className:`roadmap-syntax-code-label font-mono`,children:`Python`}),(0,b.jsx)(`pre`,{className:`code-block font-mono`,children:(0,b.jsx)(`code`,{dangerouslySetInnerHTML:{__html:st(e.pythonCode,`python`)}})})]})]})]},t)),ot.filter(e=>{let t=xe===`all`||e.category===xe,n=e.csharp.toLowerCase().includes(_e.toLowerCase())||e.python.toLowerCase().includes(_e.toLowerCase())||e.desc.toLowerCase().includes(_e.toLowerCase());return t&&n}).length===0&&(0,b.jsx)(`div`,{className:`roadmap-syntax-empty font-sans`,children:`No matching syntax rules found. Try adjusting your filters.`})]})]})]})}),(0,b.jsx)(`style`,{children:`
      ...
      `})]})};function lt(){let[e,t]=(0,_.useState)(()=>{let e=window.location.pathname;return e===`/roadmap`?`roadmap`:e.startsWith(`/blog`)?`blog`:e===`/admin`?`admin`:`home`});return(0,_.useEffect)(()=>{let t=window.location.pathname;e===`roadmap`&&t!==`/roadmap`?window.history.pushState(null,``,`/roadmap`):e===`blog`?t.startsWith(`/blog`)||window.history.pushState(null,``,`/blog`):e===`admin`&&t!==`/admin`?window.history.pushState(null,``,`/admin`):e===`home`&&t!==`/`&&window.history.pushState(null,``,`/`)},[e]),(0,_.useEffect)(()=>{let e=()=>{let e=window.location.pathname;e===`/roadmap`?t(`roadmap`):e.startsWith(`/blog`)?t(`blog`):t(e===`/admin`?`admin`:`home`)};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[]),(0,_.useEffect)(()=>{fetch(`/api/stats`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({referrer:document.referrer||``,userAgent:navigator.userAgent||``,user_agent:navigator.userAgent||``,pagePath:window.location.pathname||``,page_path:window.location.pathname||``,path:window.location.pathname||``})}).catch(e=>console.error(`Failed to log stats:`,e))},[]),(0,b.jsxs)(`div`,{className:`app-wrapper`,children:[e!==`roadmap`&&(0,b.jsx)(nt,{}),e!==`roadmap`&&(0,b.jsx)(x,{activeView:e,setActiveView:t}),(0,b.jsx)(`main`,{className:`main-content`,children:e===`home`?(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(Ge,{setActiveView:t}),(0,b.jsx)(rt,{leftText:`0x01`,rightText:`load_expertise`}),(0,b.jsx)(Ke,{}),(0,b.jsx)(rt,{leftText:`0x02`,rightText:`query_projects`}),(0,b.jsx)(Ye,{}),(0,b.jsx)(rt,{leftText:`0x03`,rightText:`read_timeline`}),(0,b.jsx)(Xe,{}),(0,b.jsx)(rt,{leftText:`0x04`,rightText:`handshake_sync`}),(0,b.jsx)(tt,{})]}):e===`roadmap`?(0,b.jsx)(ct,{}):e===`admin`?(0,b.jsx)(`div`,{className:`admin-view-wrapper`,children:(0,b.jsx)(it,{setActiveView:t})}):(0,b.jsx)(`div`,{className:`blog-view-wrapper`,children:(0,b.jsx)(Qe,{})})}),e!==`roadmap`&&(0,b.jsx)(`footer`,{className:`footer font-mono`,children:(0,b.jsxs)(`div`,{className:`container footer-container`,children:[(0,b.jsxs)(`p`,{children:[`© `,new Date().getFullYear(),`. Made with passion by Baqar Hussain Naqvi.`]}),(0,b.jsx)(`p`,{className:`footer-status`,children:`Status: Active & building`})]})}),(0,b.jsx)(`style`,{children:`
        .app-wrapper {
          display: flex;
          flex-direction: column;
          min-height: 100vh;
      ...
      `})]})}var ut=()=>{window.si||(window.si=function(...e){window.siq=window.siq||[],window.siq.push(e)})},dt=`@vercel/speed-insights`,ft=`2.0.0`;function pt(){return typeof window<`u`}function mt(){return`production`}function ht(){return mt()===`development`}function gt(e){return e.scriptSrc?vt(e.scriptSrc):ht()?`https://va.vercel-scripts.com/v1/speed-insights/script.debug.js`:e.dsn?`https://va.vercel-scripts.com/v1/speed-insights/script.js`:e.basePath?vt(`${e.basePath}/speed-insights/script.js`):`/_vercel/speed-insights/script.js`}function _t(e,t){let n=e;if(t)try{n={...JSON.parse(t)?.speedInsights,...e}}catch{}let r={sdkn:dt+(n.framework?`/${n.framework}`:``),sdkv:ft};return n.sampleRate&&(r.sampleRate=n.sampleRate.toString()),n.route&&(r.route=n.route),ht()&&n.debug===!1&&(r.debug=`false`),n.dsn&&(r.dsn=n.dsn),n.endpoint?r.endpoint=vt(n.endpoint):n.basePath&&(r.endpoint=vt(`${n.basePath}/speed-insights/vitals`)),{src:gt(n),beforeSend:n.beforeSend,dataset:r}}function vt(e){return e.startsWith(`http://`)||e.startsWith(`https://`)||e.startsWith(`/`)?e:`/${e}`}function yt(e={},t){var n;if(!pt()||e.route===null)return null;ut();let{beforeSend:r,src:i,dataset:a}=_t(e,t);if(document.head.querySelector(`script[src*="${i}"]`))return null;r&&((n=window.si)==null||n.call(window,`beforeSend`,r));let o=document.createElement(`script`);o.src=i,o.defer=!0;for(let[e,t]of Object.entries(a))o.dataset[e]=t;return o.onerror=()=>{console.log(`[Vercel Speed Insights] Failed to load script from ${i}. Please check if any content blockers are enabled and try again.`)},document.head.appendChild(o),{setRoute:e=>{o.dataset.route=e??void 0}}}function bt(){if(!(typeof process>`u`))return{}.REACT_APP_VERCEL_OBSERVABILITY_BASEPATH}function xt(){if(!(typeof process>`u`))return{}.REACT_APP_VERCEL_OBSERVABILITY_CLIENT_CONFIG}function St(e){(0,_.useEffect)(()=>{var t;e.beforeSend&&((t=window.si)==null||t.call(window,`beforeSend`,e.beforeSend))},[e.beforeSend]);let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(!t.current){let n=yt({framework:e.framework??`react`,basePath:e.basePath??bt(),...e},e.configString??xt());n&&(t.current=n.setRoute)}},[e]),(0,_.useEffect)(()=>{t.current&&e.route&&t.current(e.route)},[e.route]),null}var Ct=()=>{window.va||(window.va=function(...e){window.vaq||(window.vaq=[]),window.vaq.push(e)})},wt=`@vercel/analytics`,Tt=`2.0.1`;function Et(){return typeof window<`u`}function j(){return`production`}function Dt(e=`auto`){if(e===`auto`){window.vam=j();return}window.vam=e}function Ot(){return(Et()?window.vam:j())||`production`}function kt(){return Ot()===`development`}function At(e){return e.scriptSrc?Mt(e.scriptSrc):kt()?`https://va.vercel-scripts.com/v1/script.debug.js`:e.basePath?Mt(`${e.basePath}/insights/script.js`):`/_vercel/insights/script.js`}function jt(e,t){let n=e;if(t)try{n={...JSON.parse(t)?.analytics,...e}}catch{}Dt(n.mode);let r={sdkn:wt+(n.framework?`/${n.framework}`:``),sdkv:Tt};return n.disableAutoTrack&&(r.disableAutoTrack=`1`),n.viewEndpoint&&(r.viewEndpoint=Mt(n.viewEndpoint)),n.eventEndpoint&&(r.eventEndpoint=Mt(n.eventEndpoint)),n.sessionEndpoint&&(r.sessionEndpoint=Mt(n.sessionEndpoint)),kt()&&n.debug===!1&&(r.debug=`false`),n.dsn&&(r.dsn=n.dsn),n.endpoint?r.endpoint=n.endpoint:n.basePath&&(r.endpoint=Mt(`${n.basePath}/insights`)),{beforeSend:n.beforeSend,src:At(n),dataset:r}}function Mt(e){return e.startsWith(`http://`)||e.startsWith(`https://`)||e.startsWith(`/`)?e:`/${e}`}function Nt(e={debug:!0},t){var n;if(!Et())return;let{beforeSend:r,src:i,dataset:a}=jt(e,t);if(Ct(),r&&((n=window.va)==null||n.call(window,`beforeSend`,r)),document.head.querySelector(`script[src*="${i}"]`))return;let o=document.createElement(`script`);o.src=i;for(let[e,t]of Object.entries(a))o.dataset[e]=t;o.defer=!0,o.onerror=()=>{let e=kt()?`Please check if any ad blockers are enabled and try again.`:`Be sure to enable Web Analytics for your project and deploy again. See https://vercel.com/docs/analytics/quickstart for more information.`;console.log(`[Vercel Web Analytics] Failed to load script from ${i}. ${e}`)},document.head.appendChild(o)}function Pt({route:e,path:t}){var n;(n=window.va)==null||n.call(window,`pageview`,{route:e,path:t})}function Ft(){if(!(typeof process>`u`))return{}.REACT_APP_VERCEL_OBSERVABILITY_BASEPATH}function It(){if(!(typeof process>`u`))return{}.REACT_APP_VERCEL_OBSERVABILITY_CLIENT_CONFIG}function Lt(e){return(0,_.useEffect)(()=>{var t;e.beforeSend&&((t=window.va)==null||t.call(window,`beforeSend`,e.beforeSend))},[e.beforeSend]),(0,_.useEffect)(()=>{Nt({framework:e.framework||`react`,basePath:e.basePath??Ft(),...e.route!==void 0&&{disableAutoTrack:!0},...e},e.configString??It())},[]),(0,_.useEffect)(()=>{e.route&&e.path&&Pt({route:e.route,path:e.path})},[e.route,e.path]),null}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsxs)(_.StrictMode,{children:[(0,b.jsx)(lt,{}),(0,b.jsx)(St,{}),(0,b.jsx)(Lt,{})]}));